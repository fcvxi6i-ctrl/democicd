...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflowfinal")
    bq_project = Variable.get("bq_project", default_var="southern-shade-474113-a5")
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/airflowfinal/spark-job/spark_transformation_job.py",  # Main Python file
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "117205487987-compute@developer.gserviceaccount.com",
                "network_uri": "projects/southern-shade-474113-a5/global/networks/default",
                "subnetwork_uri": "projects/southern-shade-474113-a5/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="southern-shade-474113-a5",
        region="us-central1",
